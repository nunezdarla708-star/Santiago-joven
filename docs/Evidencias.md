...
| PF-01 | Registro | Ingresar datos válidos y aceptar condiciones | Cuenta creada, sesión iniciada y contador actualizado Aprobada  
`04_registro_usuario.png` |

| PF-02 | Registro | Intentar registrar un correo ya existente | Mensaje de error, no se crea cuenta duplicada Aprobada 

| PF-03 | Login | Usar credenciales de administrador correctas | Sesión iniciada, botón "Panel" visible  Aprobada  
`05_login_admin.png` |

| PF-04 | Login | Usar contraseña incorrecta | Mensaje "Correo o contraseña incorrectos" |  Aprobada 

| PF-05 | Recuperación | Ingresar correo existente y contraseña válida | Contraseña actualizada correctamente | Aprobada 

| PF-06 | Inscripción | Elegir actividad con cupos y completar formulario | Confirmación y disminución visible de cupos |  Aprobada
 `07_inscripcion_exitosa.png` |

| PF-07 | Inscripción | Repetir el mismo correo en la misma actividad | Sistema bloquea la segunda inscripción | Aprobada 

| PF-08 | Cupos | Revisar actividad "Taller de Pintura y Expresión" | Botón deshabilitado y mensaje "Cupos agotados" | Aprobada
 `06_control_cupos.png` |

| PF-09 | Filtros | Seleccionar filtro "Voluntariado" en actividades | Solo se muestran actividades de voluntariado | Aprobada 

| PF-10 | Galería | Filtrar por categoría y abrir imagen | Se muestran imágenes filtradas y lightbox funciona | Aprobada 
 `10_galeria_lightbox.png` |

| PF-11 | Soporte | Enviar formulario de contacto completo | Consulta registrada y visible en panel |  Aprobada | `11_soporte.png` |

| PF-12 | FAQ | Hacer clic en una pregunta frecuente | Respuesta se expande; segundo clic la contrae |  Aprobada 

| PF-13 | Chat | Preguntar por cupos o inscripciones | Respuesta automática relacionada al tema | Aprobada 

| PF-14 | Panel | Crear nueva actividad desde Panel → Actividades | Actividad visible en el sitio y en el listado del panel | Aprobada 
`08_panel_actividades.png` |

| PF-15 | Panel | Editar noticia desde Panel → Noticias | Contenido actualizado en la sección Novedades |  Aprobada 
 `12_noticias.png` |

| PF-16 | Panel | Cargar imagen (archivo o URL) desde Panel → Galería | Imagen visible en galería pública | Aprobada 
...
|---|---|---|
| Celular pequeño | 360 × 800 | Aprobada 
| Celular estándar (iPhone 14) | 390 × 844 | Aprobada 
| Tablet vertical (iPad) | 768 × 1024 | Aprobada
| Tablet horizontal | 1024 × 768 | Aprobada
| Notebook | 1366 × 768 | Aprobada
| Escritorio | 1920 × 1080 | Aprobada
...
- Las capturas deben tomarse con el navegador en modo normal
